...
const Dashboard = () => {
    ...
    // const { data: hostrole = {} } = useQuery({
    //     queryKey: ['hostrolesdata'],
    //     queryFn: () => fetch(`${process.env.REACT_APP_API_URL}/studentsftboc/${user?.email}`)
    //         .then(res => res.json())
    ...
    //     queryKey: ['studentsftboc'],
    //     queryFn: () => fetch(`${process.env.REACT_APP_API_URL}/studentsftboc/${hostRole?.nameOfClass}`)
    //         .then(res => res.json())
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7'>
                <div class="w-full max-w-sm px-4 py-3 bg-white rounded-md shadow-md dark:bg-gray-800">
                    <div class="flex items-center justify-between">
                        <span class="text-sm font-light text-gray-800 dark:text-gray-400">TMKMT HOST</span>
                        <span class="px-3 py-1 text-xs text-blue-800 uppercase bg-blue-200 rounded-full dark:bg-blue-300 dark:text-blue-900">Class {hostRole?.nameOfClass}</span>
                    </div>

                    <div>
                        <h1 class="mt-2 text-lg font-semibold text-gray-800 dark:text-white">See details and take care of your all students.</h1>
                    ...
                    <div>
                        <div class="flex items-center mt-2 text-gray-700 dark:text-gray-200">
                            ...
                            <a class="mx-2 text-blue-600 cursor-pointer dark:text-blue-400 hover:underline" tabindex="0" role="link">{studentsData?.length}</a>
                            <span>  </span>
                            <a class="mx-2 text-blue-600 cursor-pointer dark:text-blue-400 hover:underline" tabindex="0" role="link">See Details</a>
                        </div>
                ...
                <div class="w-full max-w-sm px-4 py-3 bg-white rounded-md shadow-md dark:bg-gray-800">
                    ...
                    <div>
                        <div class="flex items-center mt-2 text-gray-700 dark:text-gray-200">
                            ...
                            <span>or</span>
                            <a class="mx-2 text-blue-600 cursor-pointer dark:text-blue-400 hover:underline" tabindex="0" role="link"></a>
                        </div>
