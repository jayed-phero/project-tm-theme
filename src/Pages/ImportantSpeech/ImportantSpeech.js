...
const ImportantSpeech = () => {
    return (
        <div>
            <section class="bg-white xl:px-52 lg:px-32 md:px-20 dark:bg-gray-900">
                <div class="container px-6 py-10 mx-auto">
                    ...
                    <section class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 lg:grid-cols-2 xl:grid-cols-3">
                        {
                            [1, 2, 3].map((p, i) =>
                                <div class="p-8 border rounded-lg dark:border-gray-700 hover:border-regal-orange">
