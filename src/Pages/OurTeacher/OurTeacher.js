...
function SampleNextArrow(props) {
    ...
    return (
        <div
            ...
            style={{ display: "block", background: "gray", padding: "21px", borderRadius: "50%", border: "1px solid gray", display: "flex", justifyContent: "center", alignItems: "center" }}
            onClick={onClick}
        />
    );
}
...
function SamplePrevArrow(props) {
    ...
    return (
        <div
            className={`${className} mb-32`}
            style={{ display: "block", background: "gray", padding: "21px", borderRadius: "50%", border: "1px solid gray", display: "flex", justifyContent: "center", alignItems: "center", zIndex: "1" }}
            onClick={onClick}
        />
    );
}
