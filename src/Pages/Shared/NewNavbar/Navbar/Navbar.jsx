    ...
    <nav className={`bg-white w-full shadow-lg print:hidden relative z-50 ${nav && 'navbar-active ease-in duration-700'}`}>
      <div className="flex items-center font-medium justify-between xl:px-52 px-6 md:px-20 lg:px-32">
        ...
        >
          ...
          <li>
            <Link onClick={menuToggle} to="#blogs" className=" my-1.5 border border-regal-orange py-1.5 w-full px-3 inline-block">
              Blogs
            </Link>
          </li>
          <li>
            <Link onClick={menuToggle} to="/tmtsection" className=" my-1.5 border border-regal-orange py-1.5 w-full px-3 inline-block">
              Dashboard
            </Link>
          </li>
